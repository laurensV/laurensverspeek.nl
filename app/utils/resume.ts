...
// The JSON Resume (jsonresume.org schema v1) built from the central profile
// data — shared by the /resume.json server route and the terminal `jq` command
// so both stay in lockstep with the rest of the site.
