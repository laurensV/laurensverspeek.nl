...
export const museum: Wing[] = [
  ...
  },
  {
    ...
    exhibits: [
      ...
      { name: 'the whiteboard', how: 'type draw, or open the lvOS app', blurb: 'A shared freehand canvas — everyone here draws on the same board, you see the other visitors’ pens move live as coloured dots, strokes appear as you make them, save snapshots the board to the Gallery, and clear asks once before wiping it for all. Distinct from the pixel world: this is ink, not a grid. Solo when no relay is configured.' },
