...
export const museum: Wing[] = [
  ...
  },
  {
    ...
    exhibits: [
      ...
      { name: 'the app suite', how: 'the icon grid', blurb: 'Files, Paint, Notes, a Calculator with scientific and programmer (hex/bin/oct) modes, Minesweeper, Snake, a media player with visualizer modes, a shared whiteboard, a browser browsing this very site.' },
      ...
      { name: 'the clipboard', how: 'the clipboard icon', blurb: 'Every copy on the site — a terminal | copy, a blog code block, the vCard email, a picked colour, the palette\'s share link — lands in one rolling history. Click any entry to copy it again. One writeClipboard, one list.' },
  ...
  },
  {
    ...
    exhibits: [
      ...
      { name: 'the whiteboard', how: 'type draw, or open the lvOS app', blurb: 'A shared freehand canvas — everyone here draws on the same board, you see the other visitors’ pens move live as coloured dots, strokes appear as you make them, undo takes back your last stroke for everyone, save snapshots the board to the Gallery, and clear asks once before wiping it for all. Distinct from the pixel world: this is ink, not a grid. Solo when no relay is configured.' },
