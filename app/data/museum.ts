...
export const museum: Wing[] = [
  ...
  },
  {
    ...
    exhibits: [
      ...
      { name: 'the time machine', how: 'the time machine app, or git checkout <hash>', blurb: 'Actual time travel: every deploy of this site since 2020 is a real build sitting in the repo\'s history, and a service worker serves any of them back to you — the genuine old site, links and all, right down to the Vuetify version from before the rebuild. Pick a date from the timeline or checkout a commit hash in the terminal; a bar at the bottom brings you home. No screenshots, no reconstructions. The past, rehosted on demand.' }
    ]
  },
  {
