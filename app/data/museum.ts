...
export const museum: Wing[] = [
  ...
  },
  {
    ...
    exhibits: [
      ...
      { name: 'the whiteboard', how: 'type draw, or open the lvOS app', blurb: 'A shared freehand canvas — everyone here draws on the same board, strokes appear as you make them, and clear wipes it for all. Distinct from the pixel world: this is ink, not a grid. Solo when no relay is configured.' },
