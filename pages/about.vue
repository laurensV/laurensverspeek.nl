  ...
  <div>
    <div class="container is-max-widescreen">
      <div class="mt-6">
        <h1> Blockchain </h1>
        <p>
          Experienced blockchain and web developer with a background in Computer Science.
          Co-Founded the technology startup <a href="https://effect.ai" target="_blank">Effect.AI</a>, creating a
          micro-tasking platform to structure data on the blockchain, powered by the digital token EFX.
        </p>
        <p>
...
<script>
  import Blockchain from "~/assets/img/blockchain.svg?inline";
