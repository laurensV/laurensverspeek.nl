...
export default defineNuxtConfig({
  ...
  pwa: {
    ...
    manifest: {
      ...
      // install-sheet previews (generated by scripts/generate-pwa-screenshots.mjs
      // in postgenerate — sizes must match its viewports); with these Chrome
      // shows the rich bottom-sheet install UI instead of the bare mini prompt
      screenshots: [
        { src: '/pwa-screenshot-wide.png', sizes: '1280x720', type: 'image/png', form_factor: 'wide', label: 'The lvOS desktop' },
        { src: '/pwa-screenshot-narrow.png', sizes: '750x1624', type: 'image/png', form_factor: 'narrow', label: 'laurensverspeek.nl on a phone' }
      ],
